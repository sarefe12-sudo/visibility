          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-1.5 text-xs text-slate-500 hover:border-slate-400 hover:text-slate-800 hover:bg-slate-50 transition-all"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
